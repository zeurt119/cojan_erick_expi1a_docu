...
CREATE DATABASE IF NOT EXISTS `cojan_erick_expi1a_docu` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
...
-- Table t_docclients (sans id_client ni id_utilisateur)
...
INSERT INTO `t_docclients` (`id_doc`, `titre`, `contenu`, `date_ajout`) VALUES
  (1, 'Contrat 2023', 'Contenu du contrat signé en 2023', '2023-01-15'),
  (2, 'Facture Janvier', 'Facture pour le mois de janvier', '2023-02-01'),
  (3, 'Rapport mensuel', 'Rapport mensuel des activités', '2023-03-10'),
  (4, 'Accusé de réception', 'Confirmation de réception des documents', '2023-04-05'),
  (5, 'Plan de projet', 'Plan détaillé du projet 2024', '2024-01-20'),
  (6, 'Note technique', 'Note sur les spécificités techniques du service', '2024-02-18'),
  (7, 'Certificat', 'Certificat de conformité délivré', '2024-03-22'),
  (8, 'Historique des échanges', 'Résumé des communications par mail', '2024-04-15'),
  (9, 'Planning de maintenance', 'Planning prévu pour 2024', '2024-05-01'),
  (10, 'Lettre de remerciement', 'Lettre envoyée suite à une collaboration réussie', '2024-05-15');
